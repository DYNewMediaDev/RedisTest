...
public class UserService {
	...
	@Caching(put = { @CachePut(value = "user", key = "#user.id") }, evict = {
	...
	@Caching(
			...
			cacheable = { @Cacheable(value = "user", key = "#id") }, put = {
					@CachePut(value = "user", key = "#user.id"),
					@CachePut(value = "user", key = "#user.username") }, evict = { @CacheEvict("cache2"),
